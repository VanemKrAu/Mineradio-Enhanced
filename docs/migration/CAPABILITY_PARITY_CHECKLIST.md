...
> P8.s6.a core data + layout math + entrance animation constants ported (`packages/visual-engine/src/shelf/`); pending P8.s6.b Three.js card meshes, Canvas sprite texture updates, detail-open GSAP, pointer focus switching, RenderStepSlot.Shelf host registration. Boxes remain unchecked until visual parity is recorded.
